...
- Magnetics now selects between the same broad Magnetic Hollows, warped Flux Crystal Caverns, and narrower Polarity Grotto geometry as Overworld, using Basalt Delta, Soul Sand Valley, and Warped Forest materials and objects. Its nine floating-biome entries also share Overworld's variable vascular or crystalline tails, coherent edge-taper variation, and restrained wall warp instead of fixed-depth slab undersides.
